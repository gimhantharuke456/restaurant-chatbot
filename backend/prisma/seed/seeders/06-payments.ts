...
export async function seedPayments(completedReservations: SeedReservation[]): Promise<void> {
  ...
  const payments: Prisma.PaymentCreateManyInput[] = completed.map((reservation, i) => {
